...
const orgJsonLd = {
  ...
  description:
    "AI iOS app that creates a personalized future-self mentor for each user — delivering a 90-day roadmap and voice-based AI coaching. In its first 5 months: 22,700+ downloads, 1,900+ paid subscribers, $40K+ revenue, 20,000+ hours of AI coaching delivered, and a 4.7★ App Store rating from 636 verified reviews.",
  sameAs: [
    "https://apps.apple.com/us/app/myfutureself-achieve-success/id6745573360",
  ],
};
