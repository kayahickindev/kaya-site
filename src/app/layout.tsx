...
const orgJsonLd = {
  ...
  description:
    "AI iOS app that creates a personalized future-self mentor for each user — delivering a 90-day roadmap and voice-based AI coaching. Current traction: 26,000+ downloads, 1,900+ active paid subscribers, $77K+ ARR, 52% average monthly revenue growth, and a 4.7★ App Store rating from 715 verified reviews.",
  sameAs: [
    "https://apps.apple.com/us/app/myfutureself-achieve-success/id6745573360",
  ],
};
