...
import { metricsCaption, tractionLines, type MarketingMetricsSnapshot } from "./marketing-metrics";
  ...
  "@graph": [
    {
      ...
      alumniOf: { "@type": "CollegeOrUniversity", name: "Miami University", url: "https://miamioh.edu/" },
      worksFor: { "@id": organizationId },
      sameAs: [siteConfig.social.github, siteConfig.social.linkedin, siteConfig.social.twitter, siteConfig.social.instagram],
      knowsAbout: ["Full-stack development", "Swift", "SwiftUI", "React Native", "TypeScript", "Next.js", "Firebase", "Consumer AI", "Real-time voice AI", "Multimodal models", "Web accessibility"],
      award: [...awards.map((a) => `${a.name}, ${a.issuer}`), ...scholarships.map((s) => `${s.name}, ${s.issuer}`), "Cum laude, Miami University, 2026", "Valedictorian, Crestwood High School, 2022", "Dean's List honors, Miami University"],
    ...
    },
    {
      ...
      description: "Consumer AI for personalized future-self mentorship, 90-day roadmaps, and daily action.",
      founder: { "@id": personId },
