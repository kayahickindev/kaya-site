    ...
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
      <div className="flex flex-col gap-5 lg:col-span-7">
        <div>
          ...
          <h1 className="mt-1 text-5xl font-semibold leading-[0.9] tracking-tight text-neutral-950 sm:text-6xl xl:text-7xl dark:text-white">
            Pick a line.
          </h1>
        </div>

        <p className="max-w-xl text-base leading-relaxed text-neutral-700 xl:text-lg dark:text-neutral-300">
          Open to a technical co-founder role at founding level with equity,
          investors backing consumer AI, and builders shipping ambitious products.
        </p>

        <div className={`${cardSurface} flex flex-col gap-3 p-5`}>
          <p className="text-[10px] font-mono uppercase tracking-[0.18em] text-neutral-500">
            Direct line
          </p>
          <p className="text-2xl font-semibold tracking-tight text-neutral-950 xl:text-3xl dark:text-white">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              type="button"
              onClick={copyEmail}
              className="inline-flex h-10 items-center gap-2 rounded-md border border-black/15 bg-white/55 px-4 text-sm font-medium text-neutral-800 transition hover:-translate-y-0.5 hover:border-black/30 hover:bg-white dark:border-white/15 dark:bg-white/[0.04] dark:text-neutral-200 dark:hover:border-white/30 dark:hover:bg-white/[0.08]"
            >
              Copy address
            </button>
          </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-wrap gap-2">
            {openTo.map((item) => (
              <span
                key={item}
                className="inline-flex items-center gap-1.5 rounded-full border border-black/10 bg-white/55 px-3 py-1.5 text-xs font-medium text-neutral-800 backdrop-blur dark:border-white/15 dark:bg-white/[0.05] dark:text-neutral-200"
              >
        ...
        <div className="flex flex-col gap-2">
          {socials.map(({ href, label, handle, icon: Icon, brandClass }) => (
            <a
              ...
              className={`group relative flex items-center gap-4 overflow-hidden rounded-md border border-black/10 bg-white/55 p-4 backdrop-blur transition duration-200 dark:border-white/10 dark:bg-white/[0.04] ${brandClass}`}
            >
              ...
              <div className="flex min-w-0 flex-1 items-center justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="text-xs opacity-70">{handle}</p>
                </div>
                <ArrowUpRight
                  size={18}
                  className="shrink-0 opacity-40 transition group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:opacity-100"
                />
              </div>
            </a>
          ))}
