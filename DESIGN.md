...
- Hero: full-bleed, 100svh, dark. `HeroVideo` plays a generated clip made still
  ...
  autoplaying. The poster frame is painted underneath and the video fades in once
  it is really playing; a faint stepping grain and a vignette sit on top so it
  reads as film. Reduced motion and no-JS visitors keep the poster. The type stays
